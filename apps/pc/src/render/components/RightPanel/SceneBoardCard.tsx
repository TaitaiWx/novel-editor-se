...
export const SceneBoardCard: React.FC<SceneBoardCardProps> = React.memo(
  ({
    ...
    return (
      <div
        className={`${styles.sceneCard2} ${expanded ? styles.sceneCard2Expanded : ''}`}
      ...
      >
        ...
        <div className={styles.sceneCard2Header}>
          ...
          <div className={styles.sceneCard2Actions}>
            ...
            <button
              className={styles.sceneExpandToggle}
        ...
        {/* ── Expanded editing zone ── */}
        {expanded && (
          <div className={styles.sceneExpandedZone}>
