...
function getOutlineScopeLabel(scopeKind: PersistedOutlineScopeKind): string {
  switch (scopeKind) {
    case 'chapter':
      return '章纲';
    case 'volume':
...
function buildCompareLabel(name: string | null, scopeKind: PersistedOutlineScopeKind): string {
...
export const OutlineView: React.FC<{
  ...
  ({
    ...
    const [highlightedStoryIdeaVersionId, setHighlightedStoryIdeaVersionId] = useState<
      number | null
    >(null);
